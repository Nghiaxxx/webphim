...
function PromoSlideshow({ promotions, title }) {
    // 1. LOGIC SLIDESHOW BẮT BUỘC
    const [currentPage, setCurrentPage] = useState(0);
    const itemsPerPage = 4; // Số lượng khuyến mãi hiển thị cùng lúc
    const totalPages = Math.ceil(promotions.length / itemsPerPage);

    // Giá trị cần khớp với CSS của bạn (Ví dụ: 260px rộng, 20px gap)
    const itemWidth = 260; 
    const itemGap = 20;
            ...
            <div className="promo-slideshow-wrapper">
                ...
                <div className="promo-slideshow">
                    <div 
                        ...
                        style={{
                            // 2. LOGIC TRƯỢT: SỬ DỤNG CÁC GIÁ TRỊ VỪA KHAI BÁO
                            transform: `translateX(-${currentPage * (itemWidth * itemsPerPage + itemGap * (itemsPerPage - 1))}px)`,
