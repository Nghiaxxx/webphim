...
// 💥 VỊ TRÍ DÁN 1: THÊM STATE VÀ HÀM XỬ LÝ MODAL TẠI ĐÂY 💥
  ...
  return (
    <div className="movie-slideshow-container">
      ...
      // ... (Phần JSX của slideshow, pagination, và nút XEM THÊM) ...

        {/* ================================================= */}
        {/* 💥 VỊ TRÍ DÁN 3: THÊM TRAILER MODAL TẠI ĐÂY 💥 */}
        {/* ================================================= */}
            ...
            <div className="trailer-modal-overlay" onClick={closeTrailerModal}>
                ...
                <div className="trailer-modal-content" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="trailer-modal-header">
                        {/* Lấy tên phim từ mảng movies */}
                        <h3>{movies.find(m => extractYouTubeId(m.trailer_url) === currentTrailerId)?.title || "Trailer Phim"}</h3>
    ...
    </div> // Kết thúc component MovieSlideshow
);
}
